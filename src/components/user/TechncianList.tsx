    ...
    return (
      <div className="bg-white rounded-lg shadow-sm p-6">
        <div className="text-center py-12">
          ...
          <p className="text-gray-600">Please select an address to view available technicians.</p>
        </div>
      </div>
    );
  }
      ...
      <div className="divide-y divide-gray-200">
        {technicians.length === 0 ? (
          <div className="text-center py-12">
            ...
            <p className="text-gray-600">No technicians available in your area at the moment.</p>
          </div>
        ) : (
